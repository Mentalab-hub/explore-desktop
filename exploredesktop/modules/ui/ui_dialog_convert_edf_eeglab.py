...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_step2.setText(QCoreApplication.translate("Dialog", u"Select Folder", None))
        self.btn_browse.setText(QCoreApplication.translate("Dialog", u"Browse", None))
        self.warning_label.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\">Select a folder containing all recorded files to convert</p></body></html>", None))
    # retranslateUi
